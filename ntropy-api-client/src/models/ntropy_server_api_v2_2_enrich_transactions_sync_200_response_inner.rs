...
pub struct NtropyServerApiV22EnrichTransactionsSync200ResponseInner {
...
impl NtropyServerApiV22EnrichTransactionsSync200ResponseInner {
    pub fn new(
        transaction_id: String,
        chart_of_accounts: Vec<String>,
        error: String,
    ) -> NtropyServerApiV22EnrichTransactionsSync200ResponseInner {
        NtropyServerApiV22EnrichTransactionsSync200ResponseInner {
            transaction_id,
            logo: None,
            website: None,
